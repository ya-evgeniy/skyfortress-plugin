...
import ru.jekarus.skyfortress.v3.lang.messages.*;
...
import ru.jekarus.skyfortress.v3.serializer.language.SfDistributionLanguageSerializer;
...
import ru.jekarus.skyfortress.v3.serializer.language.messages.SfTitleMessagesLanguageSerializer;
...
//        SERIALIZERS.registerType(TypeToken.of(ItemStack.class), new SfItemStackSerializer());
        ...
        DEF_SERIALIZERS.registerType(TypeToken.of(SfDistributionLanguage.class), new SfDistributionLanguageSerializer());
        DEF_SERIALIZERS.registerType(TypeToken.of(SfTitleMessagesLanguage.class), new SfTitleMessagesLanguageSerializer());
