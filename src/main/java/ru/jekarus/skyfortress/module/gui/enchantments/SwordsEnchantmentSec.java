...
public class SwordsEnchantmentSec implements IEnchGuiSection {
    ...
    public SwordsEnchantmentSec(EnchantmentsGui gui) {
        ...
        for (SfEnchantment ench : SfConfig.ENCHANTMENT_SWORDS) {
