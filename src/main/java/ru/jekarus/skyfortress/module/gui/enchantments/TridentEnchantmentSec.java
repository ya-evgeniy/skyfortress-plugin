...
public class TridentEnchantmentSec implements IEnchGuiSection {
    ...
    public TridentEnchantmentSec(EnchantmentsGui gui) {
        ...
        for (SfEnchantment ench : SfConfig.ENCHANTMENT_TRIDENT) {
